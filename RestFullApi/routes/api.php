...
Route::resource('product.buyer', 'Product\ProductBuyerController', ['only' => ['index']]);
Route::resource('product.category', 'Product\ProductCategoryController', ['only' => ['index', 'update', 'destroy']]);
